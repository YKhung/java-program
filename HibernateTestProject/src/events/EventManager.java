...
public class EventManager {
    ...
    public static void main(String[] args) {
        ...
        while(flag){
    		...
    		"0 to stop program.\n"+
    	    "1 for creating and storing and event.\n"+
    	    "2 for printing a list of events.\n"+
    	    "3 for adding a person to an event.\n"+
    	    "4 for adding an email to a person.");
    		
        if (option.equals("1")) {
            mgr.createAndStoreEvent("My Event", "2009-10-09");
        }
            ...
            Long eventId = mgr.createAndStoreEvent("My Event", "2009-10-09");
			...
			if(option.equals("0"))
				...
				JOptionPane.showMessageDialog(null,"Invalid code entered");
        }

        HibernateUtil.getSessionFactory().close();
    }

    private Long createAndStoreEvent(String title, String theDate) {
